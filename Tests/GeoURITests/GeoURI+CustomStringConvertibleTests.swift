...
final class GeoURI_CustomStringConvertibleTests: XCTestCase {
    ...
    func testDebugDescription() throws {
        var geoURI = try GeoURI(latitude: 48.2010, longitude: 16.3695)
        XCTAssertEqual(
            "latitude: 48.201, longitude: 16.3695, altitude: nil, crs: wgs84, uncertainty: nil",
            geoURI.debugDescription
        )
        
        geoURI = try GeoURI(latitude: 48.2010, longitude: 16.3695, altitude: 183)
        XCTAssertEqual(
            "latitude: 48.201, longitude: 16.3695, altitude: Optional(183.0), crs: wgs84, uncertainty: nil",
            geoURI.debugDescription
        )
        
        geoURI = try GeoURI(latitude: 48.2010, longitude: 16.3695, altitude: 183, uncertainty: 66.60)
        XCTAssertEqual(
            "latitude: 48.201, longitude: 16.3695, altitude: Optional(183.0), crs: wgs84, uncertainty: Optional(66.6)",
            geoURI.debugDescription
        )
        
        geoURI = try GeoURI(latitude: 48.2010, longitude: 16.3695, uncertainty: 66.60)
        XCTAssertEqual(
            "latitude: 48.201, longitude: 16.3695, altitude: nil, crs: wgs84, uncertainty: Optional(66.6)",
            geoURI.debugDescription
        )
    }
